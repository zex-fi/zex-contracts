...
describe("Vault", function () {
    ...
    beforeEach(async function () {
        [owner, setter, withdrawer, user, recipient, nonceTimesGenerator] = await ethers.getSigners();
        ...
        vault = (await upgrades.deployProxy(Vault, [owner.address, await verifier.getAddress(), pubKeyX, pubKeyYParity], {initializer: "initialize"})) as unknown as Vault;
    ...
    describe("Setters", function () {
        it("should allow the owner to set the Schnorr verifier", async function () {
            ...
            await vault.connect(setter).connect(setter).setVerifier(newVerifier.address);
    ...
    describe("Nonce Management", function () {
        it("should update and retrieve user nonces", async function () {
            await vault.connect(setter).setNonce(10);
    ...
    describe("Withdrawals", function () {
        ...
        beforeEach(async function () {
            await vault.connect(setter).setNonce(0);
            const MockERC20 = await ethers.getContractFactory("MockERC20");
